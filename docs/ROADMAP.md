...
| **Phase 2 차별화** | **알파 카드 (지수 대비 수익률)** | "내 포트폴리오 vs KOSPI/SPX/60-40" 90D·1Y 비교 카드 → 홈에 추가. 전체 사용자 랭킹 대신 외부 지수 비교로 후킹 + 규제 안전 (이미 랜딩에 노출 중) |
...
| 1 | **알파 카드** — 홈에 "vs KOSPI/SPX/60-40 포트폴리오" 비교 카드 |
