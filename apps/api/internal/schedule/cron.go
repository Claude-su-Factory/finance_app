...
func Start(ctx context.Context, d Deps, aiClient ai.Client, toolRegistry *tools.Registry) *cron.Cron {
	...
	mustAdd(c, "* 7 * * *", "briefings", func() {
		if err := JobBriefingDispatcher(ctx, d, aiClient, toolRegistry); err != nil {
