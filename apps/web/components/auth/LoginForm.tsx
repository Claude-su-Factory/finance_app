...
export function LoginForm() {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      ...
      <button disabled={isSubmitting} className="w-full bg-bb-accent text-bg font-mono py-2 disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-bb-accent focus-visible:ring-offset-2 focus-visible:ring-offset-bg">
